...
- Require directory-scoped fork snapshots, fresh evidence for changed materializations, advisory handling for invalid optional tracking state, symlink-free fingerprinted source trees, and canonically contained maintenance locks.
