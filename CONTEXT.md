...
- **Owned payload**: every runtime-owned file except `customization.json` and reserved `provenance/`; symlinks are invalid, and canonical runtime selectors cannot use filesystem aliases to name excluded paths.
