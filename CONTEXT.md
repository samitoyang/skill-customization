...
- **Owned payload**: every runtime-owned file except `customization.json` and reserved `provenance/`; symlinks are invalid, and canonical, dot-free runtime selectors cannot name excluded paths under any filename casing.
